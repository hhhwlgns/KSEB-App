...
export default function ClientFormScreen() {
  ...
  const formFields = [
    { key: 'code' as keyof ClientFormData, label: '거래처 코드', placeholder: '거래처 코드를 입력하세요', autoCapitalize: 'characters' as const },
    { key: 'name' as keyof ClientFormData, label: '거래처명', placeholder: '거래처명을 입력하세요', required: true },
    { key: 'representative' as keyof ClientFormData, label: '대표자명', placeholder: '대표자명을 입력하세요' },
    { key: 'phone' as keyof ClientFormData, label: '전화번호', placeholder: '전화번호를 입력하세요', keyboardType: 'phone-pad' as const },
    { key: 'email' as keyof ClientFormData, label: '이메일', placeholder: '이메일을 입력하세요', keyboardType: 'email-address' as const, autoCapitalize: 'none' as const },
    { key: 'address' as keyof ClientFormData, label: '주소', placeholder: '주소를 입력하세요', multiline: true },
    { key: 'notes' as keyof ClientFormData, label: '비고', placeholder: '비고사항을 입력하세요 (선택사항)', multiline: true },
  ];
